...
public class Popularplcadapter extends RecyclerView.Adapter<Popularplcadapter.ViewHolder>
{

    View v;
    Context context;
    List<HomeImagmodel> mydata;

    public Popularplcadapter(Context context, List<HomeImagmodel> mydata) {
    ...
    @NonNull
    @Override
    public Popularplcadapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        v= LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_popularplcadapter,parent,false);
        ViewHolder viewHolder = new ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull Popularplcadapter.ViewHolder holder, final int position) {
